...
DWORD WINAPI on_attach(void* instance) {
	[&]() {
        ...
        SetConsoleTitleA("a l p r a z o l a m");
        ...
        interfaces::console->console_color_printf({ 255, 0, 0, 255 }, ("alprazolam | "));
        interfaces::console->console_printf(std::string("s u c c e s s f u l l y  i n j e c t e d !").append(" \n").c_str());

        if (interfaces::engine->is_in_game()) {
            interfaces::chat_element->chatprintf("#alprazolam#_print_injected");
        }
	}();
	...
	[&]() {
        ...
        // isn't right to do it like that
